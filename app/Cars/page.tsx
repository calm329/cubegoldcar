            ...
            <div className='innerCarPage flex justify-between '>
                ...
                <div className='cars w-full lg:w-[calc(100%-280px)] p-6 lg:p-3 pb-[34px]'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-between items-center w-full '>
                        <ScheduleForm title='Pick - Up' classnames="w-full lg:w-[calc(50%-21px)] px-4 py-2 lg:px-12 lg:py-6 mb-8 lg:mb-0" />
                        <ScheduleForm title='Drop - Off' classnames="w-full lg:w-[calc(50%-21px)] px-4 py-2 lg:px-12 lg:py-6 " />
                    </div>
                    <div className='flex w-full justify-between items-center flex-wrap mt-6'>
                        {[1, 2, 3, 4, 1, 2, 3, 4, 1].map((a, i) => (
                            <CarCard className="sm:max-w-[calc((100%/2)-32px)] lg:max-w-[calc((100%/3)-32px)]  xl:max-w-[calc((100%/3)-32px)] 2xl:max-w-[calc((100%/4)-32px)] mb-6" />
                        ))}
                    </div>
