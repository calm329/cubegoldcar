...
export function SiteFooter() {
  return (
    ...
    >
      <div className="pt-14 pb-[60px] flex justify-between mb-9">
      ...
      <div className="w-[calc(100%-120px)] border-black border-t-[1px] my-0 mx-auto flex justify-between items-center pt-6 ">
        <div>
          <p className="text-white">©2022 CUBAGOLDCAR. All rights reserved</p>
        </div>
        <div>
          <a  className="text-white mr-14">Privacy & Policy</a>
