...
function FilterBar({ }: Props) {
    return (
        <div className='filterBar max-w-[280px] w-full min-h-screen bg-white p-8'>
            <div className='sidebar'>
                ...
                <div>
                    ...
                    >
                        <Checkbox id="terms" className='w-5 h-5 mr-2 aspect-square data-[state=checked]:bg-[#223B80] data-[state=checked]:border-[#223B80] border-[#90a3bf] border-2   ' />
